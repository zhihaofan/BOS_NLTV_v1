...
name='patches.gif'; %Example 2
I=double(imread(name));
[M,N]=size(I);
%I=image_rescale(I,0,1); % Rescale the image to [0,1]; 
Fmask = rand(M,N);
sparsity = 0.3; 
...
%Input 
opts.h0=15; %
opts.mu=0.1; % regularization scale parameter used in NLTV 
opts.I=I; %% ground truth or a reference image to measure image quality, optional
opts.nOuter=100;
opts.nDenoising=20;
opts.nWin=2;
